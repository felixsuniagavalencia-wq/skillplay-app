...
export default function HomeScreen({ userId, onStartGame, onGoToWallet, onTopUp, onGoToProfile }: {
  ...
  const getDifficultyLabel = (diff: string) => {
    const labels: Record<string, string> = {
      basico: t('home_difficulty_basico'),
      medio: t('home_difficulty_medio'),
      avanzado: t('home_difficulty_avanzado'),
      experto: t('home_difficulty_experto'),
    };
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            ...
            <View style={styles.modalFeatures}>
              ...
              <Text style={styles.modalFeature}>🎓 {t('home_free_remaining', { count: 15 })}</Text>
      ...
      <ScrollView style={styles.container}>
        ...
        {isFreeGame ? (
          ...
          <View style={styles.countdownBanner}>
            ...
            <View>
              <Text style={styles.countdownTitle}>{t('home_free_countdown')}</Text>
        ...
        {isFreeGame && (
          ...
          >
            {loadingFree ? (
              ...
              <Text style={styles.startBtnText}>{t('home_play_free', { count: freeGamesLeft })}</Text>
            )}
          </TouchableOpacity>
        )}
